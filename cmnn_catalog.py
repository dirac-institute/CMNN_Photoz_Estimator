...
def make_test_and_train(verbose, runid, test_m5, train_m5, test_mcut, train_mcut, force_idet, force_gridet, \
    ...
    ### # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
    if user_catalog.find('full.dat') >= 0:
        if force_idet:
            ...
            if verbose: print("awk '{if ($5<"+strimagmax+") print $0}' "+ user_catalog + " > " + "temp_" + runid + ".dat")
            os.system("awk '{if ($5<"+strimagmax+") print $0}' " + user_catalog +" > " + "temp_" + runid + ".dat")
